Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/68c81fe4ff4c07c4f859313a4a533121"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				matcapALD.matcapALAlphaAdd = float4(0,1,0,0);
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(1,0.192857,0.8109996,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.192857,0.8109996,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(1,0.192857,0.8109996,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.192857,0.8109996,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(1,0.192857,0.8109996,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.192857,0.8109996,1).a);
				#endif
				matcapIntensity = (1.43 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (2.37 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (7.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
			...
			void ApplyAudioLinkVolumeColor(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0,0.8690745,1,1).rgb * poiThemeColor(poiMods, float4(0,0.8690745,1,1).rgb, (0.0 /*_ALVolumeColorLowThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (20.0 /*_ALLowEmission*/), midColor * (0.0 /*_ALMidEmission*/), saturate(volume * 2));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.2184332,0.7989575,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0.2184332,0.7989575,1).a;
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
