Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/0723c64b9800c9649a0a31cdf0263d31"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkVolumeColor(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(1,0,0.59903,1).rgb * poiThemeColor(poiMods, float4(1,0,0.59903,1).rgb, (0.0 /*_ALVolumeColorLowThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (7.33 /*_ALLowEmission*/), midColor * (0.0 /*_ALMidEmission*/), saturate(volume * 2));
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, volumeColor, (0.0 /*_ALVolumeColorBlendType*/)), saturate((0.85 /*_ALVolumeColorBlendAlpha*/) * poiMods.audioLinkAvailable));
				#endif
			}
			#endif
			#endif
